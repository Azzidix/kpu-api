				...
				<div class="collapse navbar-collapse" id="exCollapsingNavbar2">
					<ul class="nav navbar-nav">
						<li class="nav-item active">
							<a class="nav-link" href="../panitia/index.php"><span class="nav-icon"><i class="fa fa-home"></i></span>Dashboard</a>
						</li>
						<li class="nav-item">
							<a class="nav-link" href="../panitia/counting.php"><span class="nav-icon"><i class="fa fa-check"></i></span>Quick Count</a>
						</li>
			...
			<div class="container">
				<div class="content-title text-center">
					<div class="alert alert-warning mb-0" role="alert">
						Data pemilihan suara untuk Quick Count belum ada.
					</div>
				</div>
			</div>
		</section> <!-- end .content -->
